...
import frc.template.constants.AutoConversionFactors;
...
public class DifferentialDrivebaseTalonVictorS extends DifferentialDrivebaseS {
   ...
   */
  public DifferentialDrivebaseTalonVictorS(DriveConstants driveConstants, AutoConstants autoConstants) {
  ...
  public DifferentialDrivebaseTalonVictorS(NomadTalonSRX leftTalonSRX, NomadTalonSRX rightTalonSRX, DriveConstants driveConstants,
  ...
  public DifferentialDrivebaseTalonVictorS(NomadTalonSRX leftTalonSRX, NomadTalonSRX rightTalonSRX, NomadVictorSPX leftVictorSPX,
